  ...
  return (
    <div className="group relative bg-white rounded-3xl border border-gray-100 shadow-lg hover:shadow-2xl transition-all duration-500 overflow-hidden h-full flex flex-col">
      ...
      <button
        ...
        } z-20 w-10 h-10 backdrop-blur-md rounded-full flex items-center justify-center shadow-sm transition-all duration-300
          ${
            isWishlisted
      ...
      >
        <Heart
          ...
          className={`transform transition-transform ${
            isWishlisted ? "scale-110" : "group-hover:scale-110"
          }`}
        />
      </button>
      ...
      <div className="relative aspect-[4/3] overflow-hidden bg-gradient-to-br from-gray-50 to-gray-100 p-8">
        ...
        <div className="absolute inset-0 bg-black/10 opacity-0 group-hover:opacity-100 transition-opacity duration-300 flex items-center justify-center backdrop-blur-[2px]">
          <Link
            to={`/products`}
            className="transform translate-y-4 group-hover:translate-y-0 transition-transform duration-300 delay-75 inline-flex items-center gap-2 px-6 py-3 bg-white text-gray-900 rounded-full font-bold shadow-xl hover:bg-medical-50"
          >
            <Eye size={18} />
      ...
      <div className="p-6 flex flex-col flex-grow">
        ...
        <h3 className="text-xl font-bold text-gray-900 mb-2 leading-tight group-hover:text-medical-600 transition-colors">
          <Link to={`/products`}>{product.name[language]}</Link>
        </h3>
        ...
        <div className="mt-auto pt-6 border-t border-gray-100 flex items-center justify-between gap-4">
          ...
          <button
            ...
            className="flex-1 flex items-center justify-center gap-2 bg-gray-900 text-white py-3 px-4 rounded-xl font-bold hover:bg-medical-600 transition-colors shadow-lg shadow-gray-200 hover:shadow-medical-200 group/btn"
          >
            <ShoppingCart
              size={20}
              className="transform group-hover/btn:-translate-y-0.5 transition-transform"
            />
