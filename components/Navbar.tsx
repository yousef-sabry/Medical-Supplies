...
const Navbar = () => {
  ...
  return (
    <nav ref={navRef} className="sticky top-0 z-50 bg-white/90 backdrop-blur-md shadow-sm border-b border-gray-100">
        ...
        <div className="flex justify-between h-20 items-center">
          ...
          <Link to="/" className="flex items-center gap-2 group">
            ...
            <div className="flex flex-col">
              <span className="text-xl font-bold text-gray-900 leading-tight">Al-Andalus</span>
              <span className="text-xs text-medical-600 font-medium tracking-wider">MEDICAL</span>
            </div>
          </Link>
          ...
          <div className="hidden md:flex items-center gap-4">
            ...
            <Link to="/cart" className="p-2 text-gray-600 hover:text-medical-600 transition-colors relative">
